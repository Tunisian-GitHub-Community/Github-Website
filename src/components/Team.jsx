...
export const Team = ({team}) => {
  return (
      <section className="bg-gray-900 second-pattern py-12 lg:py-16 xl:py-28" id="members">
          <div className="container mx-auto px-5">
              <div className="grid gap-6 lg:gap-10 xl:grid-cols-3">
                  <div className="space-y-2 lg:space-y-4">
                      ...
                      <p className="w-full sm:w-1/2 xl:w-80 text-gray-100 md:text-lg">Meet the team moderating our
                          Community</p>
                  </div>
