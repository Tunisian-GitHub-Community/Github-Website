...
function Header() {
  return (
    <div className="Header leading-normal tracking-normal text-white bg-gray-900  pb-20">
    ...
    <div className="bg gradient">
        ...
        <span className="text-5xl text-gray-900 sm:text-7xl">
            ...
            <div className="flex mt-8">
              <a href="https://github.com/Tunisian-GitHub-Community" className=" py-2 px-4 rounded-lg bg-gray-900 border-2 border-transparent text-white text-md mr-4 hover:bg-gray-800">
                Our Github
        </a>
              <a href="https://discord.gg/MzXu6mM5eN" className="uppercase py-2 px-4 rounded-lg bg-transparent border-2 border-gray-900 text-gray-900 font-bold hover:border-gray-800  hover:text-gray-800 text-md">
                Engage
        </a>
            </div>
          </div>
    ...
    <svg viewBox="0 0 1428 174" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
      <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
        ...
        <g transform="translate(-4.000000, 76.000000)" fill="#111827" fillRule="nonzero">
