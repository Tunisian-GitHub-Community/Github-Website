...
function meet() {
  ...
  <div className="container mx-auto flex px-5 py-14 md:flex-row flex-col items-center">
    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-200">Meet The Team
        <br className="hidden lg:inline-block" />
      </h1>
      <p className="mb-8 leading-relaxed">     We are a team of coding enthusiasts, young student developers.<br/> you could be one of us !</p>
